...
interface MembershipDao {
    ...
    @Query("""
        ...
        LIMIT 1
    """)
    suspend fun findMembership(roomId: Long, userId: Long): MembershipEntity?
    ...
    """)
    suspend fun updateAdmin(roomId: Long, targetUserId: Long, isAdmin: Boolean)
    ...
    @Query("""
        ...
        AND userId = :targetUserId
    """)
    suspend fun updateCanMessage(roomId: Long, targetUserId: Long, canMessage: Boolean)
    ...
    @Query("""
        ...
        AND userId = :targetUserId
    """)
    suspend fun removeMembership(roomId: Long, targetUserId: Long)
}